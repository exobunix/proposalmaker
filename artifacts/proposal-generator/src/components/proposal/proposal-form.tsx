          ...
          <form className="space-y-6 pb-20">
            ...
            <div className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Proposal Generated By (Company or Person Name)</FormLabel>
                    <FormControl>
                      <Input placeholder="TechVision Solutions" {...field} className="bg-background" />
                    </FormControl>
                    <p className="text-[10px] text-muted-foreground">
                      This company or person name will appear on the cover page and headers/footers of the proposal. Defaults to "TechVision Solutions" if left blank.
                    </p>
                    <FormMessage />
                  </FormItem>
                )}
